...
* Python libraries: `pip install click requests tqdm pyspng ninja imageio-ffmpeg==0.4.3 psutil scipy`.  We use the Anaconda3 2020.11 distribution which installs most of these by default.
